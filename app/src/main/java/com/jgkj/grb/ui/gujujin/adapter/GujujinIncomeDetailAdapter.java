 ...
 */
public class GujujinIncomeDetailAdapter extends RecyclerView.Adapter {
    ...
    public GujujinIncomeDetailAdapter(Context mContext, List<PersonalGRBCashModel.GRBCashBean> mList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new GujujinIncomeDetailHolder(mLayoutInflater.inflate(R.layout.layout_item_gujujin_income_detail, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if (viewHolder instanceof GujujinIncomeDetailHolder) {
            ((GujujinIncomeDetailHolder) viewHolder).bindView(mList.get(i), i);
        }
    }
    ...
    class GujujinIncomeDetailHolder extends BaseViewHolder {
        ...
        public GujujinIncomeDetailHolder(View itemView) {
            super(itemView);
        }
        ...
        public void bindView(PersonalGRBCashModel.GRBCashBean bean, int position) {
            ...
            personalEquityMoney.setText(String.format("+%s", data.getWa_num()));
        }
    }
}
