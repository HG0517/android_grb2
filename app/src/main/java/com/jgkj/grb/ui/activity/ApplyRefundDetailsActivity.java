...
public class ApplyRefundDetailsActivity extends BaseActivity {
    ...
    public static void start(Context context, String backId) {
        Intent intent = new Intent(context, ApplyRefundDetailsActivity.class);
    ...
    private void initDetailStatus() {
        ...
        if (mApplyAfterDetailModel.getData().getStatus() == 1) {
            mDetailsStatus.setText(R.string.apply_refund_details_status_1);
            mDetailsStatusTip.setText(R.string.apply_refund_details_status_11);
            mDetailsAfterSalesTime.setText(String.format(getString(R.string.apply_refund_details_apply_time), mApplyAfterDetailModel.getData().getAdd_time()));
        } else if (mApplyAfterDetailModel.getData().getStatus() == 2) {
            mDetailsStatus.setText(R.string.apply_refund_details_status_2);
            mDetailsStatusTip.setText(R.string.apply_refund_details_status_21);
            mDetailsAfterSalesTime.setText(String.format(getString(R.string.apply_refund_details_apply_time), mApplyAfterDetailModel.getData().getAdd_time()));
        } else if (mApplyAfterDetailModel.getData().getStatus() == 3) {
            mDetailsStatus.setText(R.string.apply_refund_details_status_3);
            mDetailsStatusTip.setText(R.string.apply_refund_details_status_31);
            mDetailsAfterSalesTime.setText(String.format(getString(R.string.apply_refund_details_apply_time), mApplyAfterDetailModel.getData().getAdd_time()));
        } else if (mApplyAfterDetailModel.getData().getStatus() == 4) {
        } else if (mApplyAfterDetailModel.getData().getStatus() == 5) {
            mDetailsStatus.setText(R.string.apply_refund_details_status_5);
            mDetailsStatusTip.setText(R.string.apply_refund_details_status_51);
            mDetailsAfterSalesTime.setText(String.format(getString(R.string.apply_refund_details_completion_time), mApplyAfterDetailModel.getData().getEnd_time()));
