 ...
 * 退款/售后：查看详情，退货退款
 */
public class ApplyAfterRefundDetailsActivity extends BaseActivity {

    public static void start(Context context, String backId) {
        Intent intent = new Intent(context, ApplyAfterRefundDetailsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_after_refund_details);
    ...
    private void initStatusSpeed(int statusSpeed) {
        ...
        switch (statusSpeed) {
            case 1:
                mDetailsStatus.setText(R.string.apply_after_refund_details_status_1);
                ...
                break;
            case 2:
                mDetailsStatus.setText(R.string.apply_after_refund_details_status_2);
                mDetailsStatusSpeedTv0.setTextColor(Color.parseColor("#333333"));
                ...
                break;
            case 3:
                mDetailsStatus.setText(R.string.apply_after_refund_details_status_3);
                mDetailsStatusSpeedTv0.setTextColor(Color.parseColor("#333333"));
                mDetailsStatusSpeedTv1.setTextColor(Color.parseColor("#333333"));
                ...
                break;
            case 5:
                mDetailsStatus.setText(R.string.apply_after_refund_details_status_5);
                mDetailsStatusSpeedTv0.setTextColor(Color.parseColor("#333333"));
                mDetailsStatusSpeedTv1.setTextColor(Color.parseColor("#333333"));
                mDetailsStatusSpeedTv2.setTextColor(Color.parseColor("#333333"));
