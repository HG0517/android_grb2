 ...
 */
public class RegisterAgreeAbstractDialog extends DialogFragment implements RxView.Action1 {
    ...
    public static RegisterAgreeAbstractDialog newInstance() {
        return new RegisterAgreeAbstractDialog();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRootView = inflater.inflate(R.layout.layout_dialog_register_agree_abstract, container, false);
        return mRootView;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        agreeAbstractContent.setMovementMethod(ScrollingMovementMethod.getInstance());

        RxView.setOnClickListeners(this, dialogCancel, dialogSure);

        String tip = getString(R.string.register_terms_of_service_tip);
        SpannableString spannableString =
                SpannableStringUtil.getSpannableString(String.format(getString(R.string.register_terms_of_service_abstract_text), tip),
                        tip.length(), 1f, Color.parseColor("#FB355C"),
                        v -> {
                            //TermsOfServiceActivity.start(getContext());
                            ServiceHelpWebViewActivity.start(getContext(), "14");
                        });
        // 不设置点击不生效
    ...
    public void dismiss() {
        ...
        RegisterAgreeAbstractDialog.super.dismiss();
    }
