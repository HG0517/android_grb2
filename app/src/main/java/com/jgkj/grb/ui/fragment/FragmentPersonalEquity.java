...
import com.jgkj.grb.ui.adapter.PersonalEquityAdapter;
 ...
 */
public class FragmentPersonalEquity extends BaseFragment {

    public static FragmentPersonalEquity newInstance(int status) {
        FragmentPersonalEquity fragmentPersonalEquity = new FragmentPersonalEquity();
        Bundle bundle = new Bundle();
        bundle.putInt("status", status);
        fragmentPersonalEquity.setArguments(bundle);
        return fragmentPersonalEquity;
    }
    ...
    PersonalEquityAdapter mAdapter;
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new PersonalEquityAdapter(mActivity, mList);
            ...
            public void onSuccess(PersonalGRBCashModel model) {
                ...
                if (model.getCode() == 1) {
                    if (page == 1)
                        mList.clear();
                    page++;
                    mPersonalEquityTotal.setText(String.format(getString(R.string.personal_circulation_total_grc), status == 0
