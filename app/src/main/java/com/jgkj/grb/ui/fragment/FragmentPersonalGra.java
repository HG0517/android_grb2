...
import com.jgkj.grb.ui.adapter.PersonalGraAdapter;
 ...
 */
public class FragmentPersonalGra extends BaseFragment {

    public static FragmentPersonalGra newInstance(int status) {
        FragmentPersonalGra fragmentPersonalCirculation = new FragmentPersonalGra();
    ...
    public int getLayoutResId() {
        return R.layout.fragment_personal_gra;
    }
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new PersonalGraAdapter(mActivity, mList);
            ...
            public void onSuccess(PersonalGRBCashModel model) {
                ...
                if (model.getCode() == 1) {
                    if (page == 1)
                        mList.clear();
                    page++;
                    mPersonalCirculationTotal.setText(String.format(getString(R.string.personal_circulation_total_gra), status == 0
