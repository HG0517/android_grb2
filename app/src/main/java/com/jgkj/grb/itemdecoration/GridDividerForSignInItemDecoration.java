...
/**
 * GridDividerForSignInItemDecoration  签到界面：只要上下的，不要左右的
 */


public class GridDividerForSignInItemDecoration extends RecyclerView.ItemDecoration {
    private static final String TAG = "TAG_" + GridDividerForSignInItemDecoration.class.getSimpleName();

    private Paint mPaint;
    private int mDividerWidth;

    public GridDividerForSignInItemDecoration(int height, @ColorInt int color) {
...
//        right = eachWidth - left;
        ...
        //Logger.i(TAG, "itemPosition:" + itemPosition + " |left:" + left + " right:" + right + " bottom:" + bottom);
        if (isLastRow) {
            bottom = 0;
        }
//        if (isfirstRow) {
//            top = mDividerWidth; // (spanCount - 1) * mDividerWidth / spanCount
//        } else {
//            top = 0;
//        }
