...
/**
 * 说明：自定义时间选择器：适合简短选择，年月日
 */
public class DatePickerSingleShort implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private TextView mTvHourUnitFrom, mTvMinuteUnitFrom;
     ...
     */
    public DatePickerSingleShort(Context context, Callback callback, String beginDateStr, String endDateStr) {
     ...
     */
    public DatePickerSingleShort(Context context, Callback callback, long beginTimestamp, long endTimestamp) {
    ...
    private void initView() {
        ...
        if (window != null) {
            ...
            window.setContentView(R.layout.layout_dialog_date_picker_single_short);
