...
public class CustomClassicsFooter extends InternalClassics<CustomClassicsFooter> implements RefreshFooter {
    ...
    @Override
    protected CustomClassicsFooter self() {
        return this;
    }
    ...
    public CustomClassicsFooter setPrimaryColor(@ColorInt int accentColor) {
        return super.setPrimaryColor(accentColor);
    }

    public CustomClassicsFooter setAccentColor(@ColorInt int accentColor) {
