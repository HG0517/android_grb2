package com.jgkj.grb.view.refresh;
...
/**
 * 经典下拉头部
 * Created by jugekeji on 2018/11/12.
 */

public class CustomClassicsHeader extends InternalClassics<CustomClassicsHeader> implements RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public CustomClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mShared = context.getSharedPreferences("CustomClassicsHeader", Context.MODE_PRIVATE);
        setLastUpdateTime(new Date(mShared.getLong(KEY_LAST_UPDATE_TIME, System.currentTimeMillis())));

    }

    @Override
    protected CustomClassicsHeader self() {
        return this;
    }
    ...
    public CustomClassicsHeader setPrimaryColor(@ColorInt int accentColor) {
        return super.setPrimaryColor(accentColor);
    }

    public CustomClassicsHeader setAccentColor(@ColorInt int accentColor) {
        mLastUpdateText.setTextColor(accentColor & 0x00ffffff | 0xcc000000);
        return super.setAccentColor(accentColor);
    }

    public CustomClassicsHeader setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public CustomClassicsHeader setTimeFormat(DateFormat format) {
    ...
    public CustomClassicsHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

    public CustomClassicsHeader setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
    ...
    public CustomClassicsHeader setTextSizeTime(float size) {
    ...
    public CustomClassicsHeader setTextSizeTime(int unit, float size) {
    ...
    public CustomClassicsHeader setTextTimeMarginTop(float dp) {
    ...
    public CustomClassicsHeader setTextTimeMarginTopPx(int px) {
        MarginLayoutParams lp = (MarginLayoutParams) mLastUpdateText.getLayoutParams();
        lp.topMargin = px;
        mLastUpdateText.setLayoutParams(lp);
        return this;
